...
namespace MinaSidor.Server.Controllers
    ...
    public class RoleController : Controller
    {
        ...
        readonly UserManager<BovisionUser> userManager;
        public RoleController(RoleManager<IdentityRole> roleManager, UserManager<BovisionUser> userManager)
        {
        ...
        public async Task<IActionResult> ResetPassword(string UserId)
        {
            ...
            if (UserName != User.Identity.Name)
            {
                PasswordHasher<BovisionUser> hasher = new PasswordHasher<BovisionUser>();
                var User = userManager.Users.FirstOrDefault(u => u.Id == UserId);
