...
namespace MinaSidor.Core.Services.Users;
...
public interface IUsersService
{
    ...
    /// <summary>
    /// Gets a page with groups of the Agent.
    /// </summary>
    /// <param name="AgentId">An ID of the Agent.</param>
    /// <param name="filter">Optional filter for groups.</param>
    /// <returns>
    /// A page with groups of the Agent with ID <paramref name="AgentId"/>.
    /// </returns>

    /// <summary>
    /// Gets a page with semesters of the Agent.
    /// </summary>
    /// <param name="AgentId">An ID of the Agent.</param>
    /// <param name="filter">Optional filter for semesters.</param>
    /// <returns>
    /// A page with semesters of the Agent with ID <paramref name="AgentId"/>.
    /// </returns>
}
